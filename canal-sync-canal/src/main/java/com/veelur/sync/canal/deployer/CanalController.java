...
import com.veelur.sync.canal.deployer.monitor.InstanceAction;
import com.veelur.sync.canal.deployer.monitor.InstanceConfigMonitor;
import com.veelur.sync.canal.deployer.monitor.ManagerInstanceConfigMonitor;
import com.veelur.sync.canal.deployer.monitor.SpringInstanceConfigMonitor;
...
public class CanalController {
    ...
    public CanalController(final Properties properties) {
        ...
        if (autoScan) {
            ...
            instanceConfigMonitors = MigrateMap.makeComputingMap(new Function<InstanceConfig.InstanceMode, InstanceConfigMonitor>() {

                public InstanceConfigMonitor apply(InstanceConfig.InstanceMode mode) {
                ...
                if (config.getMode().isManager()) {
                    ...
                    synchronized (CanalEventParser.class) {
                        try {
                            ...
                            InstanceMonitorModel model = CanalLauncher.CLIENTS.get(destination);
                            if (model == null) {
                                logger.warn("InstanceMonitorModel expect[Valuable],but is null.");
                                model = new InstanceMonitorModel();
                            }
                            System.setProperty("canal.instance.master.address", model.getAddress());
                            System.setProperty("canal.instance.dbUsername", model.getDbUsername());
                            System.setProperty("canal.instance.dbPassword", model.getDbPassword());
                            System.setProperty("canal.instance.defaultDatabaseName", model.getDefaultDatabaseName());
                            System.setProperty("canal.instance.filter.regex", model.getWhiteRegex());
                            ...
                            System.setProperty("canal.instance.master.address", "");
                            System.setProperty("canal.instance.dbUsername", "");
                            System.setProperty("canal.instance.dbPassword", "");
                            System.setProperty("canal.instance.defaultDatabaseName", "");
                            System.setProperty("canal.instance.filter.regex", "");
                        }
                    }
                } else {
