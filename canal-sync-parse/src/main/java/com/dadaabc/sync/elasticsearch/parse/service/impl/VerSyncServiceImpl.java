package com.dadaabc.sync.elasticsearch.parse.service.impl;

import com.dadaabc.sync.elasticsearch.parse.service.VerElasticsearchService;
import com.dadaabc.sync.elasticsearch.parse.service.VerMappingService;
import com.dadaabc.sync.elasticsearch.parse.service.VerSyncService;
...
import com.veelur.sync.component.canal.BaseDaoSupportCache;
...
public class VerSyncServiceImpl implements VerSyncService, InitializingBean, DisposableBean {
    ...
    public boolean syncByIndex(SyncByIndexRequest request) throws InfoNotRightException {
        ...
        List<Map<String, Object>> maps = baseDaoSupportCache.getSupportByDataSource(mainModel.getDatasource())
                .selectByPKWithPage(mainModel.getDatabase(), mainModel.getTable(),
                        0, request.getLimit(),
    ...
    public void threadExec(VerDatabaseTableModel mainModel, List<VerDatabaseTableModel> insetDataTables,
        ...
        do {
            synchronized (lock) {
                maps = baseDaoSupportCache.getSupportByDataSource(mainModel.getDatasource())
                        .selectByPKWithPage(mainModel.getDatabase(), mainModel.getTable(),
                                0, _limit,
    ...
    private void dealToEs(List<VerDatabaseTableModel> models, Map<String, Map<String, Object>> mapList,
        ...
        for (VerDatabaseTableModel tableModel : models) {
            ...
            try {
                subMaps = baseDaoSupportCache.getSupportByDataSource(tableModel.getDatasource()).selectByPKStr(tableModel.getDatabase(), tableModel.getTable(),
